...
/* ----------------------------------------------------------------------------- */
	...
	var spotlightVideo = $("#spotlight-home");
    $(".spotlight-video").click(function(){
      //spotlightVideo.trigger('stop.bx-slider.autoplay');
      $(this).find('iframe').attr("src", $(this).find('iframe').attr("src").replace("autoplay=0", "autoplay=1"));
      $(this).find('.videoOverlay').hide();
    });
	
/* ----------------------------------------------------------------------------- */
/* ------------------------- // Login and Register Js 22-01-18 ------------------------- */
/* ----------------------------------------------------------------------------- */
$(document).ready(function(e) {
    $(".send-verification").click(function(){
      $(".otp-container").css('display','block');
      $(".hide-signup-listing").css('display','none');
   });

   $(".otp-forgot-password-submit").click(function(){
      $(".otp-forgot-password").css('display','block');
      $(".forgot-password-listing").css('display','none');
   })
